...
Before the 19th century, water management often reflected localized, multi-functional values [4, 5, 8]. Water was valued for its diverse uses (drinking, commerce, waste, defense, transport, hydropower) [4] and managed through empirical practices, particularly within "hydraulic communities" that sought equilibrium with nature [5]. In regions like Venice and Holland, early modern land reclamation and water exploitation for agriculture were driven by values of productivity and expansion, yet with nascent awareness of environmental impact [3].

### Phase 2: 19th Century – Commodification, Control, and Utilitarianism
The 19th century marked a significant shift toward viewing water as a commodity to be controlled and exploited [5, 8]. "Administrative states" asserted centralized control over water resources for state objectives and industrial needs, often clashing with local "hydraulic communities" [5]. Industrialization and urbanization intensified the utilitarian value of water for industry and waste disposal, leading to the marginalization of traditional multi-functional water networks in urban centers [4]. Water's "compound nature" discovery also facilitated its conceptualization as a uniform commodity [8].
...
From the late 20th century, growing environmental awareness began to challenge the purely utilitarian and productivity-focused values [2]. Scientists, activists, and citizens questioned the environmental impacts of large-scale interventions, advocating for the protection of socio-ecological systems like wetlands [2]. Contemporary water management has progressed to recognize and integrate ecological values, moving beyond engineering control and market mechanisms to include "working with natural water ecosystems" [7]. This reflects a re-appreciation of water's qualitative diversity and its role in supporting broader environmental quality [8].
...
- **Local Communities/Peasants:** Historically valued water for subsistence, diverse local uses, and maintaining an equilibrium with nature [4, 5].
- **Landowners/Entrepreneurs:** Drove reclamation and water exploitation for economic gain and agricultural expansion [3].
- **State Engineers/Administrative States:** Emphasized centralized control, exploitation for state objectives (e.g., industrial, agricultural), and later, large-scale engineering solutions for flood control and drainage [2, 5].
...
- **Hydraulic Technologies (early modern to 19th C):** Facilitated exploitation (canals, dams, irrigation) and management for multi-functional uses. Local technical cultures emerged around these [3, 4, 5].
- **Industrial-era Technologies (19th C):** Reinforced the commodification of water, with new technologies like electricity and railroads replacing water's traditional functions, leading to its aesthetic and functional marginalization in some urban contexts [4, 8].
...
- **France and Italy (19th C):** Highlighted the tension between local "hydraulic communities" and state-led administrative control [5].
- **Central and Eastern Europe:** Many historical river transformations driven by values of agricultural production and flood protection [1].
...
The corpus indicates a gradual but significant emergence of ecological values:
...
- **Contemporary integration:** Ecological values are now a recognized pillar of water management, advocating for "working with natural water ecosystems" [7] and re-appreciating the qualitative diversity of water for environmental quality [8].

## Consensus findings (within this corpus)
1. There has been a clear historical trajectory from localized, multi-functional water management to state-led, utilitarian control, followed by a re-integration of ecological considerations.
2. Technology and science have been fundamental in enabling these transformations and shaping the dominant values.
3. Conflict has been inherent between local/traditional practices and centralized/state-led management over time.
